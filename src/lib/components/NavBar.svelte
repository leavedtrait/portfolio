...
<div class="drawer">
	...
	<div class="drawer-content flex flex-col">
		<div class="navbar fixed top-0 bg-base-200/30 p-3 backdrop-blur-md">
			<!-- Mobile Menu Button (Shown on small devices) -->
			...
			<!-- Centered Menu (Hidden on small devices, shown on large devices) -->
			<div class="navbar-center hidden flex-1 lg:flex">
				<ul class="menu menu-horizontal space-x-3 text-xl font-semibold">
					<li>
			...
			<div class="navbar-end hidden flex-1 md:flex">
				<!-- External Links hidden on small devices-->
				<ul class="menu menu-horizontal hidden flex-none md:flex">
					<li>
				...
				{:else}
					<div
						class="btn-glass btn flex items-center rounded-lg border-2 border-r-2 px-4 py-2 text-sm font-semibold"
					>
						<SignIn provider=" " signInPage="signin" class="" />
						<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
							<path
								d="M15,3C8.373,3,3,8.373,3,15c0,5.623,3.872,10.328,9.092,11.63C12.036,26.468,12,26.28,12,26.047v-2.051
                    c-0.487,0-1.303,0-1.508,0c-0.821,0-1.551-0.353-1.905-1.009c-0.393-0.729-0.461-1.844-1.435-2.526
			...
			<div class="navbar-end flex-1 sm:flex md:hidden">
				{#if $page.data.user}
					<ul class="menu menu-horizontal flex-none sm:flex md:hidden">
						<li>
							<a aria-label="github profile" href="https://github.com/leavedtrait">
								<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30">
									<path
	...
	<div class="drawer-side">
		...
		<div class="menu menu-vertical min-h-full w-80 space-y-3 bg-base-200 p-4">
